    ...
    try {
      ...
      String sql =
          "CREATE TABLE IF NOT EXISTS inodes("
              ...
              + "   id bigint, namespace int, name text, value text"
              + ");"
              + "CREATE TABLE IF NOT EXISTS acls("
              + "   snapId bigint, id bigint, index int, entry int,"
              + "   PRIMARY KEY(snapId, id, index)"
              + ");"
              + "CREATE TABLE IF NOT EXISTS quotas("
              + "   id bigint primary key, quotaNameSpace bigint, quotaStorageSpace bigint,"
              + "   ramDisk bigint, ssd bigint, disk bigint, archive bigint, provided bigint"
              + ");"
